...
def download_data():
    """Download and process data if not present"""
    if not os.path.exists("data/processed/listings_enriched.csv"):
        st.info("Downloading and processing data... This may take a few minutes.")
        os.system("python pipeline/ingest.py")
        os.system("python pipeline/clean.py")
        os.system("python pipeline/enrich.py")
